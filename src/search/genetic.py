...
# only breed 80% of the time, otherwise pass parents through
CROSSOVER_RATE = 0.8


def _pick_parent(pop, fitness, k=3, rng=None):
    # pick k random plans and return the best one
...
def run_genetic(pool, user_prefs, rng=None, pop_size=50, n_generations=100, mutation_rate=0.1):
    ...
    for gen in range(n_generations):
        # score everyone in the curr pop
        ...
        # update global best if this gen did better
        ...
        # always keep the best plan so we don't accidentally lose it
