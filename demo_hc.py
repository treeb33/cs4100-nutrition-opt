...
"""
Demo script — run hill climbing and print a readable weekly meal plan.

Usage (from repo root, with venv active):
    python demo.py --csv data/RAW_recipes.csv
"""
...
def main():
    ...
    print(f"\nRunning hill climbing (seed={args.seed}, {args.restarts} restarts) ...\n")
    rng = random.Random(args.seed)
    plan, score = hill_climb_with_restarts(
        pool, user_prefs, rng=rng, n_restarts=args.restarts
    )
